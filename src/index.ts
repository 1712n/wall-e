...
async function commitGeneratedCode(params: CommitGeneratedCodeParams) {
	...
	const fileBanner = addBanner
		? '// ⚠️ This file is auto-generated by wall-e.\n// Do not edit directly — update the spec file and regenerate instead.'
		: '';
	const formattedCode = await prettier.format(fileBanner ? `${fileBanner}\n\n${generatedCode}` : generatedCode, {
